...
flowchart TD
    ...
    subgraph CD_PROCESS ["🚀 3. TIẾN TRÌNH CD GATE & AUTO-DEPLOY (CHỈ NHÁNH MAIN)"]
        ...
        L -->|Nếu Pass 100%| M["🔑 Bước 2: Tự động SSH vào VPS qua GitHub Secrets"]
        
        subgraph VPS_AUTOMATION ["Thực thi tự động trên VPS (Qua SSH Action)"]
            M --> N1["📁 Chuyển vào thư mục ~/stayaway trên VPS"]
            N1 --> N2["🔄 Đồng bộ mã nguồn mới nhất: git fetch & git reset --hard origin/main"]
            N2 --> N3["🔐 Trích xuất mật khẩu & Docker Network từ container roomi-db"]
            N3 --> N4["🐳 Đóng gói lại Docker Images: Backend (JRE 17) & Frontend (Nginx Alpine)"]
