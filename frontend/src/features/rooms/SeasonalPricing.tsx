...
const SeasonalPricing: React.FC<SeasonalPricingProps> = ({ roomTypeId, basePrice = 0 }) => {
  ...
  const handleOpenEdit = (price: any) => {
    setFormData({
      ...
      {expanded && (
        <div className="p-4 bg-surface-container-lowest">
          <div className="flex justify-between items-center mb-3">
            ...
            <Button onClick={handleOpenCreate} icon={IoAddOutline} className="text-xs py-1.5 px-3">
              Thêm mùa
            </Button>
          </div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-on-surface-variant mt-0.5">
                        {Math.ceil((new Date(price.endDate).getTime() - new Date(price.startDate).getTime()) / (1000 * 60 * 60 * 24))} đêm
                      </p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex gap-1">
                      <button
                        ...
                        className="p-1.5 rounded hover:bg-surface-blue-light hover:text-primary transition-colors text-on-surface-variant cursor-pointer"
                        title="Sửa"
                      >
                      ...
                      <button
                        ...
                        className="p-1.5 rounded hover:bg-red-50 hover:text-error transition-colors text-on-surface-variant cursor-pointer"
                        title="Xóa"
                      >
