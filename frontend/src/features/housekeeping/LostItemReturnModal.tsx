    ...
    >
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="bg-slate-50 dark:bg-slate-800/80 p-3.5 rounded-xl border border-slate-200 dark:border-slate-700 space-y-1.5">
          <div className="text-xs text-slate-500 dark:text-slate-400">Món đồ bàn giao:</div>
        ...
        <div className="bg-blue-50 dark:bg-blue-950/40 border border-blue-200 dark:border-blue-800/60 rounded-xl p-3 flex items-start gap-2.5">
          <IoShieldCheckmarkOutline className="w-5 h-5 text-blue-600 dark:text-blue-400 shrink-0 mt-0.5" />
        ...
        <div>
          ...
          <div className="relative">
            <IoPersonOutline className="absolute left-3 top-3 text-slate-400 w-4 h-4" />
            <input
              type="text"
              required
        ...
        <div>
          ...
          <div className="relative">
            <IoCallOutline className="absolute left-3 top-3 text-slate-400 w-4 h-4" />
            <input
              type="tel"
