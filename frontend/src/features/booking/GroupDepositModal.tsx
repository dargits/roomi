...
import { GroupBookingResponse, DepositResponse } from '../../types';

interface GroupDepositModalProps {
  isOpen: boolean;
  onClose: () => void;
...
const GroupDepositModal: React.FC<GroupDepositModalProps> = ({ isOpen, onClose, group, onSuccess }) => {
