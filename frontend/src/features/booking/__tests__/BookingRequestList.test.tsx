...
describe('BookingRequestList Component', () => {
  ...
  it('renders booking request list with items properly', async () => {
    vi.mocked(bookingRequestApi.getAllBookingRequests).mockResolvedValue(mockRequests as any);
  ...
  it('renders empty state when there are no requests', async () => {
    vi.mocked(bookingRequestApi.getAllBookingRequests).mockResolvedValue([]);
