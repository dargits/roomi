...
/**
 * Chuyển Date hoặc string sang định dạng YYYY-MM-DD theo giờ địa phương (local time)
 * Tránh lỗi lệch lùi 1 ngày do hàm .toISOString() chuyển về giờ UTC
 */
export const toLocalISODate = (date?: Date | string | null): string => {
  if (!date) return '';
