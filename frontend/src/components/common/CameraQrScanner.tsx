...
import { parseCccdQr, ParsedCccdData } from '../../utils/cccdParser';
...
export interface CameraQrScannerProps {
  onScan?: (parsed: ParsedCccdData, rawText: string) => void;
  placeholder?: string;
...
const CameraQrScanner: React.FC<CameraQrScannerProps> = ({ 
  ...
  const [lastScannedResult, setLastScannedResult] = useState<ParsedCccdData | null>(null);
  ...
  const lastDecodeTimestampRef = useRef<number>(0);
        ...
        <div className="flex items-center justify-between px-3.5 py-2.5 bg-surface-container-lowest border-b border-border-grey">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="p-1.5 text-on-surface-variant hover:text-primary rounded-md hover:bg-surface-container transition-colors cursor-pointer"
            >
            ...
            <div className="p-3 bg-red-50 border border-red-200 text-red-700 rounded-lg text-xs space-y-2">
              ...
              <div className="flex gap-2 pt-1">
                <button
                  type="button"
                  onClick={startCamera}
                  className="flex items-center gap-1 px-2.5 py-1 bg-red-600 text-white rounded text-[11px] font-medium hover:bg-red-700 cursor-pointer"
                >
                ...
                <button
                  type="button"
                  onClick={() => setMode('manual')}
                  className="flex items-center gap-1 px-2.5 py-1 bg-white border border-red-300 text-red-800 rounded text-[11px] font-medium hover:bg-red-50 cursor-pointer"
                >
          ...
          <div className="flex items-center justify-between text-xs pt-1">
            <div className="flex items-center gap-2">
              ...
              <button
                ...
                disabled={isProcessingFile}
                className="text-primary hover:text-primary-dark font-medium flex items-center gap-1 text-[11px] hover:underline uppercase cursor-pointer"
              >
            ...
            {isScanning && (
              <button
                ...
                className="text-on-surface-variant hover:text-primary flex items-center gap-1 text-[11px] uppercase cursor-pointer"
              >
          ...
          <div className="relative">
            ...
            {manualInput && (
              <button
                ...
                className="absolute right-2 top-1/2 -translate-y-1/2 px-2 py-1 bg-primary text-white rounded text-[11px] font-medium hover:bg-primary-dark cursor-pointer"
              >
                Xác nhận
              </button>
            )}
