...
import { IoWarningOutline, IoTrashOutline, IoInformationCircleOutline, IoClose } from 'react-icons/io5';
...
const ConfirmDialog: React.FC<ConfirmDialogProps> = ({
  ...
  const iconConfig: Record<string, { Icon: React.ComponentType<{ className?: string }>; bg: string; btn: string }> = {
    danger: {
      Icon: IoTrashOutline,
