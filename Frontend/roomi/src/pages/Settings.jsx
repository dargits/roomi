...
function Settings({ user, showNotification }) {
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="card" style={{ width: '100%', padding: '28px' }}>
          ...
          {user.role !== 'ADMIN' && (
            <>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(220px, 1fr))', gap: '16px' }}>
                <div>
                  <label style={{ marginBottom: '6px', fontWeight: '600', display: 'block' }}>Giờ nhận phòng mặc định</label>
                  <input
                    type="text"
                ...
                <div>
                  <label style={{ marginBottom: '6px', fontWeight: '600', display: 'block' }}>Giờ trả phòng mặc định</label>
                  <input
                    type="text"
                ...
                <div>
                  <label style={{ marginBottom: '6px', fontWeight: '600', display: 'block' }}>Hạn hủy phòng miễn phí (Giờ)</label>
                  <input
                    type="number"
                    min="0"
                ...
                <div>
                  <label style={{ marginBottom: '6px', fontWeight: '600', display: 'block' }}>Phí hủy trễ (%)</label>
                  <input
                    type="number"
                    min="0"
                    max="100"
