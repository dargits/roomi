...
const StayingGuestsModal = ({ isOpen, onClose, booking, onUpdated }) => {
  ...
  const handleMarkLeftEarly = async (guest) => {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Danh sách khách cùng phòng & Khai báo lưu trú" maxWidth="max-w-4xl">
      <div className="space-y-5">
        {/* Header thông tin phòng & sức chứa */}
                        ...
                        <div className="flex items-center justify-center gap-2">
                          {!guest.leftEarlyAt && (
                            <button
                              ...
                              className="px-2 py-1 text-xs text-amber-700 hover:bg-amber-50 rounded border border-amber-300 font-medium transition-colors"
