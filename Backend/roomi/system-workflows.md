...
### 2.5. Quy Trình Dọn Phòng (Nhân Viên Buồng Phòng)

```
1. Đăng nhập hệ thống
2. Xem danh sách phòng cần dọn (trạng thái CAN_DON)
3. Ưu tiên phòng có khách sắp nhận (theo thứ tự thời gian)
4. Dọn dẹp phòng theo tiêu chuẩn
5. Hoàn thành dọn phòng:
   - Đánh dấu phòng đã dọn xong
   - Hệ thống chuyển trạng thái phòng: SAN_SANG
6. Phòng sẵn sàng cho khách tiếp theo
```
